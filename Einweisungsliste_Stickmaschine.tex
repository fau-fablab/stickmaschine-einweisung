%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% COPYRIGHT: (C) 2012-2022 FAU FabLab and others
% CC-BY-SA 3.0
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{Einweisungsliste Stickmaschine Brother VR}
\fancyfoot[C]{\hspace{7em} \small https://github.com/fau-fablab/stickmaschine-einweisung}
...
\begin{itemize}
 ...
 \item unter Anleitung erfolgreich ein Werkstück mit der Stickmaschine bearbeitet habe
\end{itemize}
